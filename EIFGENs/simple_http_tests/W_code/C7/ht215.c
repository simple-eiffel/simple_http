...
extern EIF_TYPED_VALUE F215_3543(EIF_REFERENCE);
...
EIF_TYPED_VALUE F215_3543 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "has_file_parameter";
	RTEX;
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 214, Current, 2, 0, 4413);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(214, Current, 4413);
	RTIV(Current, RTAL);
	RTHOOK(1);
