...
extern EIF_TYPED_VALUE F350_3425(EIF_REFERENCE);
...
EIF_TYPED_VALUE F350_3425 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 349, Current, 0, 0, 3473);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(349, Current, 3473);
	RTIV(Current, RTAL);
