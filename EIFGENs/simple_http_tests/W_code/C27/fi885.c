...
extern EIF_TYPED_VALUE F885_3701(EIF_REFERENCE);
extern void F885_7398(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F885_3701 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 884, Current, 0, 0, 5025);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(884, Current, 5025);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F885_7398 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 884, Current, 0, 7397);
	RTSA(dtype);
	RTME(dtype, 0);
