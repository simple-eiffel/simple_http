...
extern EIF_TYPED_VALUE F890_3703(EIF_REFERENCE);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F890_3703 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 889, Current, 0, 0, 5055);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(889, Current, 5055);
	RTIV(Current, RTAL);
	RTHOOK(1);
