...
extern void F369_3596(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F369_3596 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 368, Current, 0, 1, 4864);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(368, Current, 4864);
	RTCC(arg1, 368, l_feature_name, 1, RTWCT(3008, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
