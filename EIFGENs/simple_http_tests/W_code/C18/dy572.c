...
extern EIF_TYPED_VALUE F572_4237(EIF_REFERENCE);
extern void F572_4243(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F572_4244(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F572_4247(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F572_4248(EIF_REFERENCE);
extern EIF_TYPED_VALUE F572_4249(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F572_4237 (EIF_REFERENCE Current)
{
	GTCX
...
/* {DYNAMIC_CHAIN}.prune */
void F572_4243 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 571, Current, 0, 1, 6998);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F572_4244 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
void F572_4247 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 571, Current, 3, 1, 6994);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(571, Current, 6994);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2992, "item", loc3))(loc3)).it_b);
				ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3041, "target_index", loc3))(loc3)).it_i4);
...
void F572_4248 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 571, Current, 0, 0, 6995);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(571, Current, 6995);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F572_4249 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 571, Current, 2, 1, 6996);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(571, Current, 6996);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
