...
extern EIF_TYPED_VALUE F561_3701(EIF_REFERENCE);
extern void F561_7398(EIF_REFERENCE, int);
...
/* {FINITE}.is_empty */
EIF_TYPED_VALUE F561_3701 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 560, Current, 0, 0, 5009);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(560, Current, 5009);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {FINITE}._invariant */
void F561_7398 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 560, Current, 0, 7397);
	RTSA(dtype);
	RTME(dtype, 0);
