...
extern EIF_TYPED_VALUE F62_1102(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet();

extern EIF_TYPED_VALUE F62_1103(EIF_REFERENCE);extern EIF_INTEGER_32 en_addrinfo_af_inet6();
...
EIF_TYPED_VALUE F62_1102 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 61, Current, 0, 0, 1161);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
EIF_TYPED_VALUE F62_1103 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 61, Current, 0, 0, 1162);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(61, Current, 1162);
