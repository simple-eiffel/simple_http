...
extern EIF_TYPED_VALUE F37_819(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_820(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_821(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_822(EIF_REFERENCE);
extern EIF_TYPED_VALUE F37_823(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F37_816,911,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 911);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(36, Current, 911);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {391,0xFF01,294,0xFFFF};
		EIF_TYPE typres0;
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 912);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(36, Current, 912);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000184, 0,0); /* Result */
...
RTOID (F37_819)
EIF_TYPED_VALUE F37_819 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 913);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(36, Current, 913);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000184, 0,0); /* Result */
...
RTOID (F37_820)
EIF_TYPED_VALUE F37_820 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 36, Current, 0, 0, 914);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(36, Current, 914);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000184, 0,0); /* Result */
...
EIF_TYPED_VALUE F37_821 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F37_821,916,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F37_822 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F37_822,917,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F37_823 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F37_823,918,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
