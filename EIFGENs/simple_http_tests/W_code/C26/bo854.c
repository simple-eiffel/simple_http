...
extern EIF_TYPED_VALUE F854_3703(EIF_REFERENCE);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F854_3703 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 853, Current, 0, 0, 5053);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(853, Current, 5053);
	RTIV(Current, RTAL);
	RTHOOK(1);
