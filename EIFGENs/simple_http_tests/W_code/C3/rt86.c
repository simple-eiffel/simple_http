...
extern void F86_1359(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define uw1 uw1x.it_c4
	...
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWC(5044, Dtype(tr1)))(tr1, uw1x, ui4_1x);
	RTNHOOK(1,2);
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(3406, "put_string_32", tr2))(tr2, ur1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F86_1359 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 85, Current, 0, 1, 1401);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(85, Current, 1401);
	RTCC(arg1, 85, l_feature_name, 1, eif_new_type(295, 0x01), 0x01);
	RTIV(Current, RTAL);
