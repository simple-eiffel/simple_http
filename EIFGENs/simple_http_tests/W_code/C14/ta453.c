...
extern void F453_3596(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {TABLE}.bag_put */
void F453_3596 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 452, Current, 0, 1, 4866);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(452, Current, 4866);
	RTCC(arg1, 452, l_feature_name, 1, RTWCT(3008, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
