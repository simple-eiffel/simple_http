...
extern EIF_TYPED_VALUE F987_3612(EIF_REFERENCE);
...
EIF_TYPED_VALUE F987_3612 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 986, Current, 0, 0, 4931);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(986, Current, 4931);
	RTIV(Current, RTAL);
	RTHOOK(1);
