...
extern EIF_TYPED_VALUE F818_3703(EIF_REFERENCE);
extern void F818_7399(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F818_3703 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 817, Current, 0, 0, 5051);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(817, Current, 5051);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F818_7399 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 817, Current, 0, 7398);
	RTSA(dtype);
	RTME(dtype, 0);
