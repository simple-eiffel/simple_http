...
extern EIF_TYPED_VALUE F608_4237(EIF_REFERENCE);
extern void F608_4243(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F608_4244(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F608_4247(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F608_4248(EIF_REFERENCE);
extern EIF_TYPED_VALUE F608_4249(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F608_4237 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 607, Current, 0, 0, 7003);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(607, Current, 7003);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DYNAMIC_CHAIN}.prune */
void F608_4243 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 607, Current, 0, 1, 7004);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(607, Current, 7004);
	RTIV(Current, RTAL);
...
void F608_4244 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 607, Current, 0, 1, 7005);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(607, Current, 7005);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
void F608_4247 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 607, Current, 3, 1, 7000);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(607, Current, 7000);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
body:;
	...
	if (RTAL & CK_ENSURE) {
		...
		for (;;) {
			...
			if ((EIF_BOOLEAN) (ti4_4 > arg1)) {
				tw1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2992, "item", loc3))(loc3)).it_c4);
				ti4_4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3041, "target_index", loc3))(loc3)).it_i4);
...
void F608_4248 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 607, Current, 0, 0, 7001);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(607, Current, 7001);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("prunable", EX_PRE);
...
EIF_TYPED_VALUE F608_4249 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uw1 uw1x.it_c4
	...
	RTEAA(l_feature_name, 607, Current, 2, 1, 7002);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(607, Current, 7002);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
