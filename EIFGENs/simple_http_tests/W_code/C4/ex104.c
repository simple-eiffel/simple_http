...
extern EIF_TYPED_VALUE F104_1555(EIF_REFERENCE);
...
RTOID (F104_1555)
EIF_TYPED_VALUE F104_1555 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 103, Current, 0, 0, 1585);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
