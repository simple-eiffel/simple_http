...
extern EIF_TYPED_VALUE F103_1551(EIF_REFERENCE);
extern EIF_TYPED_VALUE F103_1552(EIF_REFERENCE);
extern EIF_TYPED_VALUE F103_1553(EIF_REFERENCE);
extern void F103_1554(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
EIF_TYPED_VALUE F103_1551 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 102, Current, 1, 0, 1581);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(102, Current, 1581);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(1462, dtype))(Current, up1x);
	RTHOOK(3);
...
RTOID (F103_1552)
EIF_TYPED_VALUE F103_1552 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 102, Current, 0, 0, 1582);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(102, Current, 1582);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F103_1553)
EIF_TYPED_VALUE F103_1553 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 102, Current, 0, 0, 1583);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(102, Current, 1583);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000097, 0,0); /* Result */
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {662,266,0xFFFF};
		EIF_TYPE typres0;
...
void F103_1554 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_p
	...
	RTEAA(l_feature_name, 102, Current, 0, 1, 1584);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
...
{
	GTCX
	RTOTS (1552,F103_1552)
	RTOTS (1553,F103_1553)
}
