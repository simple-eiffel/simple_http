...
extern EIF_TYPED_VALUE F419_3703(EIF_REFERENCE);
extern void F419_7399(EIF_REFERENCE, int);
...
/* {BOUNDED}.full */
EIF_TYPED_VALUE F419_3703 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 418, Current, 0, 0, 5033);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(418, Current, 5033);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {BOUNDED}._invariant */
void F419_7399 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 418, Current, 0, 7398);
	RTSA(dtype);
	RTME(dtype, 0);
